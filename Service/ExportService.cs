            ...
            if (path.Exists)
            {
                using (ExcelPackage p = new ExcelPackage(path))
                {
                    ...
                    for (int i = 0; i < jobs.Count; i++)
                    {
                        ...
                        worksheet.Cells["F" + (i + startRows)].Value = cost == 0 ? "NA" : ((int)(Math.Ceiling((_eng_cost / cost) * 100))).ToString();
                        worksheet.Cells["H" + (i + startRows)].Value = jobs[i].status;
                        worksheet.Cells["J" + (i + startRows)].Value = jobs[i].term_payment.down_payment * 0.01;
                        worksheet.Cells["K" + (i + startRows)].Value = jobs[i].term_payment.document_submit * 0.01;
                        worksheet.Cells["L" + (i + startRows)].Value = jobs[i].term_payment.instrument_vendor * 0.01;
                        worksheet.Cells["M" + (i + startRows)].Value = jobs[i].term_payment.instrument_delivered_ctl * 0.01;
                        worksheet.Cells["N" + (i + startRows)].Value = jobs[i].term_payment.system_delivered_ctl * 0.01;
                        worksheet.Cells["O" + (i + startRows)].Value = jobs[i].term_payment.fat * 0.01;
                        worksheet.Cells["P" + (i + startRows)].Value = jobs[i].term_payment.delivery_instrument * 0.01;
                        worksheet.Cells["Q" + (i + startRows)].Value = jobs[i].term_payment.delivery_system * 0.01;
                        worksheet.Cells["R" + (i + startRows)].Value = jobs[i].term_payment.progress_work * 0.01;
                        worksheet.Cells["S" + (i + startRows)].Value = jobs[i].term_payment.installation_work_complete * 0.01;
                        worksheet.Cells["T" + (i + startRows)].Value = jobs[i].term_payment.commissioning * 0.01;
                        worksheet.Cells["U" + (i + startRows)].Value = jobs[i].term_payment.startup * 0.01;
                        worksheet.Cells["V" + (i + startRows)].Value = jobs[i].term_payment.as_built * 0.01;
                        worksheet.Cells["W" + (i + startRows)].Value = jobs[i].term_payment.warranty * 0.01;
                        worksheet.Cells["X" + (i + startRows)].Value = jobs[i].term_payment.finished * 0.01;
                        worksheet.Cells["Y" + (i + startRows)].Value = jobs[i].job_eng_in_hand;
                        worksheet.Cells["Z" + (i + startRows)].Value = jobs[i].eng_invoice;
                        worksheet.Cells["AA" + (i + startRows)].Value = (jobs[i].eng_invoice / jobs[i].job_eng_in_hand);
                        worksheet.Cells["AB" + (i + startRows)].Value = jobs[i].job_date.ToString("dd/MM/yyyy");
                    }
                    p.SaveAs(stream);
                    stream.Position = 0;
                }
