...
namespace WebENG.LeaveServices
{
    ...
    {
        public string SendCreate(string form, List<string> to, string description)
        {
            try
            {
                ...
                <body>
                    <div class=""email-wrapper"">
                        <div class=""header"">
                            <h1>ใบลาของท่านถูกส่งกลับ</h1>
                        </div>

                        <div class=""content"">
                            <p>เรียนท่านผู้ลา</p>
                            <p>ผู้อนุมัติได้พิจารณาใบลาของท่านแล้ว และส่งกลับเพื่อให้แก้ไขเพิ่มเติม</p>

                            <div style=""background:#fff3e0; border-left:4px solid #ff9100; padding:15px; margin:20px 0; border-radius:8px;"">
                                <strong>สถานะใบลา:</strong> <span style=""color:#e65100;font-weight:600;"">ส่งกลับเพื่อแก้ไข</span>
                            </div>

                            <div class=""info-card"">
                                <table style=""width:100%; border-collapse:collapse;"">
                                    <tr><th width=""140"" align=""left"" style=""padding:8px 0;"">ประเภทการลา</th><td>ลากิจ</td></tr>
                                    <tr><th align=""left"" style=""padding:8px 0;"">วันที่ลา</th><td>20-21</td></tr>
                                    <tr><th align=""left"" style=""padding:8px 0;"">ผู้พิจารณา</th><td>ปปปปปปปปปปป</td></tr>
                                </table>
                            </div>

                            <div style=""background:#fff8e1; border-radius:8px; padding:18px; margin:25px 0; line-height:1.6;"">
                                <strong>ความเห็นจากผู้อนุมัติ:</strong><br><br>
                                หนากหนดนดาดาหกนาหด
                            </div>

                            <div style=""text-align:center;"">
                                <button type=""button"" class=""btn - single"" style=""letter - spacing:1px; border: none"">
                                    <a href = ""https://yourcompany.com/Leave/Detail/12345?token=abc123xyz""
                                    style = ""text-decoration:none; color:inherit; display:block; width:100%; height:100%;border:none"" >
                                    <i class=""fas fa-edit fa-fw""></i> แก้ไขใบลาเดี๋ยวนี้
                                    </a>
                                </button>
                            </div>

                            <div style=""background:#e3f2fd; padding:15px; border-radius:8px; text-align:center; margin-top:20px;"">
                                คลิกปุ่มด้านบนเพื่อไปแก้ไขใบลา<br>
                                <small>หลังแก้ไขเสร็จ กรุณากด “ส่งอนุมัติใหม่” อีกครั้ง</small>
                            </div>
                        </div>

                        <div class=""footer"">
                            <p>ระบบการลาออนไลน์ • บริษัท คอนโทรลอจิค จำกัด</p>
                            <p>หากมีข้อสงสัยกรุณาติดต่อฝ่ายบุคคล โทร. 02-xxx-xxxx ต่อ 888</p>
